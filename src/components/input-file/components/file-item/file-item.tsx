...
const fileItem = tv({
  slots: {
    ...
    icon: "rounded-full border-4 border-violet-100 bg-violet-200 p-2 text-violet-600 dark:border-zinc-800 dark:bg-zinc-700 dark:text-zinc-400",
    deleteButton: "",
  },
  variants: {
    state: {
      progress: {
        container: "border-violet-500 dark:border-zinc-700",
      },
      error: {
      ...
      {isStateError ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            ...
            <span className="text-error-600 text-sm dark:text-error-500">{file.name}</span>
          </div>
        ...
        <div className="flex flex-1 flex-col items-start gap-1">
          ...
          <div className="flex w-full items-center gap-3">
            ...
            <span className="text-sm font-medium text-zinc-700 dark:text-zinc-300">80%</span>
          </div>
        </div>
      )}
